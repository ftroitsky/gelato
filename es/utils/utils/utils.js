...
export var findBestPlan = function findBestPlan(plans, _ref) {
  ...
  if (plans && plans.length) {
    ...
    plans.forEach(function (_ref2, index) {
      var size = _ref2.size,
          val = _ref2.priceConverted.val;
...
export var filterPlans = function filterPlans(plans, _ref3) {
  var days = _ref3.days,
      size = _ref3.size,
...
export var combineAppUrl = function combineAppUrl(partnerId, filters) {
...
export var getAppWidgetParams = function getAppWidgetParams(props) {
...
var sendMessage = function sendMessage(frameName, props) {
  return new Promise(function (resolve) {
    var messageListener = function messageListener(_ref4) {
      var _ref4$data = _ref4.data,
          action = _ref4$data.action,
          frameNameResponse = _ref4$data.frameNameResponse,
          other = _objectWithoutProperties(_ref4$data, ['action', 'frameNameResponse']);
...
export var getPlans = function getPlans(frameName, _ref5) {
...
export var sendGaEvent = function sendGaEvent(frameName, event) {
