...
export var findBestPlan = function findBestPlan(plans) {
...
export var filterPlans = function filterPlans(plans, _ref2) {
  var days = _ref2.days,
      size = _ref2.size,
...
export var getPlans = function getPlans(frameName, _ref4) {
