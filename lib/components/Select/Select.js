  ...
  function Select(props) {
    ...
    _this.filterOpt = function () {
      ...
      if (showAllNames || value.length === 0) {
        ...
        var fuse = new _fuse2.default(optionsState, fuseOptions);
  ...
  Select.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_Icons.IconSearch, { className: classes.search }),
...
Select.propTypes = process.env.NODE_ENV !== "production" ? {
  defValue: _propTypes2.default.string,
...
exports.default = withClasses(Select);